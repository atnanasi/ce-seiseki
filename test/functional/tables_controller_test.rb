...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { eigo: @table.eigo, kokugo: @table.kokugo, mess: @table.mess, name: @table.name, number: @table.number, sansu: @table.sansu }
    end
  ...
  test "should update table" do
    put :update, id: @table, table: { eigo: @table.eigo, kokugo: @table.kokugo, mess: @table.mess, name: @table.name, number: @table.number, sansu: @table.sansu }
    assert_redirected_to table_path(assigns(:table))
  end
